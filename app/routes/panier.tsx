        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 xl:gap-16">
          ...
          <div className="lg:col-span-1">
            <div className="bg-surface-container-low p-6 sticky top-24">
              ...
              {/* CTA principal : paiement en ligne */}
              <Link to="/checkout"
              ...
              <a href={`https://wa.me/23797193723?text=${whatsappMsg}`}
                ...
                className="w-full flex items-center justify-center gap-2 py-3 border border-outline-variant text-on-surface font-sans text-sm font-semibold hover:border-primary hover:text-primary transition-colors mb-3">
